...
public class AlgumaLexer extends Lexer {
	...
	public static final int
		Letra=1, Digito=2, PCAgoritmo=3, Variavel=4;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Letra", "Digito", "PCAgoritmo", "Variavel"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "Letra", "Digito", "PCAgoritmo", "Variavel"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 2:
			PCAgoritmo_action((RuleContext)_localctx, actionIndex);
			break;
		case 3:
	...
	private void PCAgoritmo_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			 System.out.print("[Palavra-chave,"+getText()+"]");
			break;
		}
	}
