// Generated from c:/Users/jakso/Desktop/Trabalhos/COMPILADORES-2025/T2/alguma-sintatico/src/main/antlr4/br/ufscar/dc/compiladores/alguma/sintatico/LA.g4 by ANTLR 4.13.1
...
public class LAParser extends Parser {
	...
	public static final int
		ALGORITMO=1, FIM_ALGORITMO=2, DECLARE=3, TIPO=4, VAR=5, CONSTANTE=6, REGISTRO=7, 
		FIM_REGISTRO=8, INTEIRO=9, REAL=10, LITERAL=11, LOGICO=12, FALSO=13, VERDADEIRO=14, 
		E=15, OU=16, NAO=17, SE=18, SENAO=19, ENTAO=20, FIM_SE=21, CASO=22, SEJA=23, 
		FIM_CASO=24, ENQUANTO=25, FIM_ENQUANTO=26, PARA=27, FIM_PARA=28, FACA=29, 
		ATE=30, PROCEDIMENTO=31, FIM_PROCEDIMENTO=32, FUNCAO=33, FIM_FUNCAO=34, 
		RETORNE=35, LEIA=36, ESCREVA=37, ATRIBUICAO=38, IGUAL=39, DIFERENTE=40, 
		MAIOR=41, MENOR=42, MAIOR_IGUAL=43, MENOR_IGUAL=44, MAIS=45, MENOS=46, 
		MULTIPLICACAO=47, DIVISAO=48, MOD=49, PONTEIRO=50, ENDERECO=51, ABREPAR=52, 
		FECHAPAR=53, ABRECOL=54, FECHACOL=55, DOIS_PONTOS=56, VIRGULA=57, PONTO_PONTO=58, 
		PONTO=59, CADEIA_NAO_FECHADA=60, CADEIA=61, NUM_INT=62, NUM_REAL=63, IDENT=64, 
		COMENTARIO_FECHADO=65, COMENTARIO_NAO_FECHADO=66, WS=67, ERRO=68;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'algoritmo'", "'fim_algoritmo'", "'declare'", "'tipo'", "'var'", 
			"'constante'", "'registro'", "'fim_registro'", "'inteiro'", "'real'", 
			"'literal'", "'logico'", "'falso'", "'verdadeiro'", "'e'", "'ou'", "'nao'", 
			"'se'", "'senao'", "'entao'", "'fim_se'", "'caso'", "'seja'", "'fim_caso'", 
			"'enquanto'", "'fim_enquanto'", "'para'", "'fim_para'", "'faca'", "'ate'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ALGORITMO", "FIM_ALGORITMO", "DECLARE", "TIPO", "VAR", "CONSTANTE", 
			"REGISTRO", "FIM_REGISTRO", "INTEIRO", "REAL", "LITERAL", "LOGICO", "FALSO", 
			"VERDADEIRO", "E", "OU", "NAO", "SE", "SENAO", "ENTAO", "FIM_SE", "CASO", 
			"SEJA", "FIM_CASO", "ENQUANTO", "FIM_ENQUANTO", "PARA", "FIM_PARA", "FACA", 
			"ATE", "PROCEDIMENTO", "FIM_PROCEDIMENTO", "FUNCAO", "FIM_FUNCAO", "RETORNE", 
			"LEIA", "ESCREVA", "ATRIBUICAO", "IGUAL", "DIFERENTE", "MAIOR", "MENOR", 
			"MAIOR_IGUAL", "MENOR_IGUAL", "MAIS", "MENOS", "MULTIPLICACAO", "DIVISAO", 
			"MOD", "PONTEIRO", "ENDERECO", "ABREPAR", "FECHAPAR", "ABRECOL", "FECHACOL", 
			"DOIS_PONTOS", "VIRGULA", "PONTO_PONTO", "PONTO", "CADEIA_NAO_FECHADA", 
			"CADEIA", "NUM_INT", "NUM_REAL", "IDENT", "COMENTARIO_FECHADO", "COMENTARIO_NAO_FECHADO", 
			"WS", "ERRO"
		};
	}
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 10737418328L) != 0)) {
				{
				setState(106);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(171);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -2305843009213669376L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final CorpoContext corpo() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 18)) & ~0x3f) == 0 && ((1L << (_la - 18)) & 70373040065169L) != 0)) {
				{
				{
				setState(234);
				cmd();
